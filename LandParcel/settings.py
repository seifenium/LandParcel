"""
Django settings for LandParcel project.
...
INSTALLED_APPS = [
    ...
    'MyMaps', # Add the MyMaps app to the INSTALLED_APPS list
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATES_DIR], # Add the templates directory to the DIRS list
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'LandParcel.wsgi.application'
